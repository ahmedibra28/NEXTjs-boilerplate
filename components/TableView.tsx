...
const TableView = (props: any) => {
  ...
  function getDeepObjValue(item: any, s: string) {
      ...
      <table className='table table-sm table-border'>
        <thead className='border-0'>
          <tr>
            ...
            {table.header.map((item: any, index: number) => (
          ...
          {table?.data?.data.map((item: any) => {
            return (
              <tr key={item._id}>
                ...
                {table?.body.map((keys: any, i: number) => {
                  return (
                    <td key={i} className={keys?.class}>
                      {getDeepObjValue(item, keys)}
                    </td>
                  )
                })}
